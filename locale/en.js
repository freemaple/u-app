export default {
	...
	login: {
		...
		and: "and",
		policy_check: "By continuing, you agree to {site_name}'s",
		password: 'Password',
		...
		container_letter: "Must contain at least 1 letter",
		...
		skip: "Skip",
		register_get_tips: "{count} OFF New User Coupon! #DRESSINSALE and exclusive deals as low as $0.99 plus free shipping!"
	},
	register_bonus: {
	...
	forget_password: {
		...
		success_tip_4: "- If you still haven't received the email after doing the above, you can try resending it or contact",
	...
	search: {
		searchCount: "{searchCount} Product Found",
		searchCounts: "{searchCount} Products Found",
		no_more: "No More Product",
		shoppingfor: 'Search by {site_name}',
		hot: "Popular Search Terms",
	...
	checkout_coupon: {
		...
		out_off_market_stock_tips:"#DRESSINSALE Out Of Stock Tips",
	...
	my_coupons: {
		...
		newComer:{
			...
			title2:'The Following Coupons Are Avaliable',
			ok:'USE NOW',
	...
	coupon_list: {
		...
		valid_to:"to",
		expect_to_save_money:"Requirements met. Use this coupon now to save <text style='color:#FF004D'>{money}</text>.",
	...
	address: {
		...
		billing_address_block: {
			...
			tip_content2:'You currently have no saved billing addresses. Fill out the form below to add a new billing address.',
	...
	cart: {
		...
		out_stock_popup:{
			...
			content:"Enter your email, we'll notify you by mail once it's restocked.",
			content_success:'Success! You will receive an email notification once the item is restocked.',
		},
		off_shelf_popup:{
			title:'I Still Wanna It',
	...
	pay_order: {
		...
		points_block: {
			...
			points_1:'points',
			my_points:'MY POINTS',
			option_use_all:'Use all available points (You save: <text style="color:#FF004D">{num}</text>)',
			option_give_use_point:"Don't apply {site_name} points to this order",
			option_enter_use_point:'Enter custom point amount',
			points_exchange_ratio:'1 point(s) will deduct <text style="color:#FF004D">{num}</text> from your total'
		},
		wallet_block: {
			title: 'Wallet:',
			total:'Total:',
		...
		order_summary: {
			...
			free:'Free',
			reward_points:'Reward <text style="color:#FF004D;">{points}</text> {site_name} Points',
			free: 'Free'
		},
		subtotal: "Subtotal",
		dressin_point: '{site_name} Points',
		...
		use_point_placeholder: "Please enter a number",
		apply_all: "All",
		apply_btn: "APPLY",
		remove_btn: "REMOVE",
	...
	pay: {
		...
		payment_fail_tip: 'Please verify that your payment information is correct or switch to another payment method to complete your order.',
		payment_fail_contact: 'If the problem persists, contact our Customer Care team at {contacts_email}.',
		try_again: "Try Again",
	...
	fission_sharing: {
		...
		success_popup: {
			...
			text2: 'Returning to the previous <br>page in <span style="color:#FF004D">{num}</span> seconds.',
			text3: 'GO SHOPPING'
		},
