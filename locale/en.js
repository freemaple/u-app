export default {
	...
	register: {
		...
		special_subscribed_tip: "Sign me up for emails to receive updates, access to exclusive deals, and more."
	...
	address: {
		...
		billing_address_block: {
			...
			tip_content2:"You don't currently have a saved billing address. Fill out the form below to add a new billing address.",
		...
		use_default_address: "Set as your default shipping address",
		...
		street1_rule:"Please enter your address.",
	...
	cart: {
		...
		choose_attribute_tip:'Please select attribute',
	...
	pay_order: {
		...
		address_block: {
			search_placeholder:'Search Name/Phone Number'
		},
		billing_address_block: {
			tip_title:'{site_name} Tips',
			tip_content:'Your billing address has been successfully saved. Please provide us with an accurate shipping address to continue.',
		...
		points_block: {
			...
			points_exchange_ratio:'1 point can be deducted <text style="color:#8A61E7">{num}</text>'
		},
		wallet_block: {
			title: 'Wallet:',
			total:'Total:',
		...
		my_wallet: 'My Wallet',
		total: "Total",
		point_tip:"The {site_name} points will be added to your account once you confirm receipt of your order. Some items in your current shopping cart are not eligible for additional point rewards.",
		point_tip_btn:"OK",
	...
	pay: {
		...
		order_fail_orderno: 'Your order number is',
		payment_fail_tip: 'Please verify your payment information or switch to another payment method to complete your order.',
	...
	distribute: {
		...
		generateurl: {
			...
			save_to_my_wallet:'Save To My Wallet',
			claim_to_my_wallet:'Claim To My Wallet',
	...
	orderAftersales: {
		input_reason: "Other Reason",
		input_reason_placeholder: "Please input your reason here",
		input_reason_error: "Please let us know why you're returning your item(s).",
	...
	fission_sharing: {
		...
		pay_success_share_popup_title: 'Invite Via',
		success_popup: {
